                        ...
                        <div class="nk-block nk-block-lg">
                            <div class="card card-bordered">
                                <div class="card-inner">
                                    <form method="post" action="{{ route('description.update') }}">
                                        @csrf
                                        ...
                                        <textarea class="tinymce-basic form-control" name="description">Job Description!</textarea>
                                        <br>
                                        <div class="row gy-4">
                                            <div class="col-12">
                                                        ...
                                                        @foreach($jobs as $job)
                                                            <div class="g">
                                                                <div class="custom-control custom-checkbox">
                                                                    <input type="checkbox" class="custom-control-input" name="job_id " id="{{ $job->id }}" value="{{ $job->id }}">
