...
@push('js')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            var html= '<tr class="nk-tb-item"><td class="nk-tb-col" colspan="2">@error('description')<span class="form-note text-danger">* {{ $message }}</span>@enderror<div class="row g-4"><div class="col-12"><div class="form-control-wrap"><div class="input-group"><textarea class="tinymce-basic form-control" name="description[]" aria-label="With textarea"></textarea><input type="hidden" name="job_id[]" value="{{ $job->id }}"><div class="input-group-prepend"><span class="input-group-text"><button class="btn btn-outline-danger btn-dim" id="remove"><em class="icon ni ni-delete"></em></button></span> </div></div></div></div></div></td></tr>';
            var x =1;
            var max =10;
            $("#add").click(function () {
                if (x<=max){
