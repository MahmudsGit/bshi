...
class ApplicationController extends Controller
{
    ...
    function store(Request $request){
        ...
        if(!$validator->passes()){
            ...
            if( $query ){
                return response()->json(['status'=>1, 'msg'=>'New Application has been successfully Completed']);
            }
        }
    }
    ...
    public function save(Request $request){
        ...
        $reference_2 = json_encode([
            ...
            $candidate->birth_date = Carbon::createFromFormat('m/d/Y', $request->birth_date)->format('Y/m/d');
            $candidate->age = $age;
            ...
            $candidate->reg_date = Carbon::createFromFormat('m/d/Y', $request->reg_date)->format('Y/m/d');
            ...
            $candidate->bank_draft_date = Carbon::createFromFormat('m/d/Y', $request->bank_draft_date)->format('Y/m/d');
            $candidate->save();
